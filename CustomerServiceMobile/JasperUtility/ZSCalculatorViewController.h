...
@protocol ZSCalculatorDelegate <NSObject>
@required
-(void)setResult: (NSString*)result status:(BOOL)status;
@end

enum ZSCalculatorOperator: NSInteger
{
    NONE = 0,
    PLUS = 1,
    MINUS = 2,
...
@interface ZSCalculatorViewController : UIViewController 
    
@property (weak,nonatomic) IBOutlet UILabel *lblValue;
@property (weak,nonatomic) id<ZSCalculatorDelegate>delegate;
