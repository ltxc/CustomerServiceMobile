...
@interface ZSAutoCompleteController ()

@end

@implementation ZSAutoCompleteController
...
- (void)searchAutocompleteEntriesWithSubstring:(NSString *)substring {
    ...
    for(id object in _objects) {
        ...
        ZSAutoCompleteField* field = [[ZSAutoCompleteField alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [(ZSAutoCompleteField*)[_autoCompletes objectAtIndex:indexPath.row] display];
    return cell;
}
...
-(void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    id selected = [(ZSAutoCompleteField*)[_autoCompletes objectAtIndex:indexPath.row] value];
